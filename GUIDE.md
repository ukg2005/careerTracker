...
> [!WARNING]  
> **Legacy Documentation Notice:** The frontend of this project was recently migrated from **React + Vite** to **SvelteKit**. This guide extensively details the legacy React implementation (which can be useful for historical context or understanding the backend). For the most up-to-date documentation on the new SvelteKit architecture, please see `project_documentation.md`.
...
> **Note:** The frontend implementation was recently completely overhauled. For deep-dive explanations on the SvelteKit frontend (including routing, state management with `$state` runes, and data fetching), please see the `project_documentation.md` file.

---

## 11. Common Bugs & Why They Happen
